...
*/
import { ScanSearch, Shield, User, Users } from 'lucide-react'
...
export const USER_ROLES = {
  ...
  [USER_ROLE.PROMPT_AUDITOR]: {
    labelKey: 'Prompt Auditor',
    value: USER_ROLE.PROMPT_AUDITOR,
    icon: ScanSearch,
  },
  [USER_ROLE.ADMIN]: {
    labelKey: 'Admin',
...
export const getUserRoleOptions = (t: (key: string) => string) => [
  ...
  {
    label: t('Prompt Auditor'),
    value: String(USER_ROLE.PROMPT_AUDITOR),
    icon: ScanSearch,
  },
